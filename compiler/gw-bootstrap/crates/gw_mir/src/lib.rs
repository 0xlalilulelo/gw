...
fn primitive_from_ast(ty: gw_ast::Type<'_>, sm: &SourceMap) -> Option<Ty> {
    let path = match ty {
        gw_ast::Type::Path(p) => p,
        _ => return None,
    };
    ...
    gw_resolve::primitive_type_name(name).map(|p| match p {
        gw_resolve::PrimitiveTy::U0 => Ty::U0,
        gw_resolve::PrimitiveTy::Bool => Ty::Bool,
        gw_resolve::PrimitiveTy::I8 => Ty::Int(IntTy::I8),
        gw_resolve::PrimitiveTy::I16 => Ty::Int(IntTy::I16),
        gw_resolve::PrimitiveTy::I32 => Ty::Int(IntTy::I32),
        gw_resolve::PrimitiveTy::I64 => Ty::Int(IntTy::I64),
        gw_resolve::PrimitiveTy::U8 => Ty::Int(IntTy::U8),
        gw_resolve::PrimitiveTy::U16 => Ty::Int(IntTy::U16),
        gw_resolve::PrimitiveTy::U32 => Ty::Int(IntTy::U32),
        gw_resolve::PrimitiveTy::U64 => Ty::Int(IntTy::U64),
        gw_resolve::PrimitiveTy::ISize => Ty::Int(IntTy::ISize),
        gw_resolve::PrimitiveTy::USize => Ty::Int(IntTy::USize),
        gw_resolve::PrimitiveTy::F32 => Ty::Float(FloatTy::F32),
        gw_resolve::PrimitiveTy::F64 => Ty::Float(FloatTy::F64),
        gw_resolve::PrimitiveTy::Rune => Ty::Rune,
    })
}
